...
<div id="investment-section" class="row-fluid">
    <div class="span8">
        ...
        <div class="row-fluid">
            <div class="span6 info-block"><img alt="Design" src="/img/wm/info-box-design.jpg" />
                <h3>design</h3>
            </div>

            <div class="span6 info-block"><img alt="Training" src="/img/wm/info-box-training.jpg" />
                <h3>training</h3>
            </div>
        </div>

        <div class="row-fluid">
            <div class="span6 info-block"><img alt="Advanced ROI Metrics" src="/img/wm/info-box-metrics.jpg" />
                <h3>advanced ROI metrics</h3>
            </div>

            <div class="span6 info-block"><img alt="Web Solutions" src="/img/wm/info-box-web.jpg" />
                <h3>web solutions</h3>
            </div>
        </div>

        <div class="row-fluid">
            <div class="span6 info-block"><img alt="Mobile Solutions" src="/img/wm/info-box-mobile.jpg" />
                <h3>mobile solutions</h3>
            </div>

            <div class="span6 info-block"><img alt="Video" src="/img/wm/info-box-video.jpg" />
                <h3>video</h3>
            </div>
        </div>
    </div>
