        ...
        <?=Form::open_for_files($controller_alias . '/store', null, array('class' => 'form-horizontal')); ?>
            <fieldset>
                ...
                <div class="control-group{{ isset($errors) && $errors->has('published_at') ? ' error' : '' }}">
                    ...
                    <div class="controls">
                        <?=Form::text('published_at', Input::old('published_at') ? Input::old('published_at') : date('Y-m-d', time()), array('class' => 'span6 date-widget', 'required' => 'required', 'placeholder' => 'Enter Date Published')); ?>
